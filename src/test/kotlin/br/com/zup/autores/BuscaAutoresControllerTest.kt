...
internal class BuscaAutoresControllerTest {
    ...
    @BeforeEach
    internal fun setup() {
        val enderecoResponse = EnderecoResponse("Rua B", "Moc", "MG")
        val endereco = Endereco(enderecoResponse, "11111-11", "30")
        autor = Autor("Gleydson", "gleydson@email.com", "Aprendiz", endereco)
